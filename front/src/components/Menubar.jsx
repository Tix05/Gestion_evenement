...
const Menubar = () => {
    ...
    return (
        <div className="flex">
            <div
                className={`flex h-screen flex-col items-center justify-between py-5 bg-purple-200 transition-all duration-100 border-menubar ${isOpen ? "w-60" : "w-20"}`}
            >
                ...
                <div className="space-y-5 flex flex-col items-start justify-center">
                    ...
                    <Link to="/list-event" className="relative group no-underline flex items-center justify-center">
                        <TbList className="text-4xl text-gray-700" />
                        {isOpen && (
                            <span
                                className={`text-lg outline-none font-semibold ${location.pathname === "/list-event"
                                    ? "bg-gray-500 py-1 px-3 rounded-md text-white cursor-default"
                                    : "text-gray-700 py-1 px-3 link-scale"
                                    }`}
                            >
